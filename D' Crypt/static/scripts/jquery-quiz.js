...
DISCLAIMER:
Plugin was made by jchamill.
Link to plugin: https://github.com/jchamill/jquery-quiz
Adjustments to code were made by me for the purpose of adapting it for this project.
Refer to external_license > jquery-quiz LICENSE.txt for more information.
*/
  ...
  $.quiz = function(el, options) {
    ...
    base.methods = {
      ...
      setup: function() {
        ...
        $.each(questions, function(i, question) {
          ...
          $.each(question.options, function(index, answer) {
            quizHtml += '<li><a href="#" data-index="' + index + '" class="text-decoration-none">' + answer + '</a></li>';
          });
          quizHtml += '</ul>';
          quizHtml += '</div>';
        });
        ...
        quizHtml += '<a href="#" id="quiz-next-btn" class="btn btn-white">' + nextButtonText + '</a>';
        quizHtml += '<a href="#" id="quiz-finish-btn" class="btn btn-white">' + finishButtonText + '</a>';
        quizHtml += '<a href="#" id="quiz-restart-btn" class="btn btn-white">' + restartButtonText + '</a>';
        quizHtml += '</div>';
        quizHtml += '</div>';
      ...
      reset: function() {
        ...
        base.$el.removeClass().addClass('quiz-container col-md-8 my-4');
        $('#quiz-restart-btn').hide();
        $(gameOverScreen).hide();
        $(resultsScreen).hide();
        $('#quiz-controls').hide();
